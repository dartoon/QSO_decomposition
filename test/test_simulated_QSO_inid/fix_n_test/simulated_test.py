...
fixed_source.append({'R_sersic': 0.2})#, 'center_x': -0.027,'center_y': -0.003, 'qso_x': 0.009,'qso_y': -0.017,'e1': -0.062592224365596166, 'e2': 0.080528893354289297})
#fixed_source.append({})
