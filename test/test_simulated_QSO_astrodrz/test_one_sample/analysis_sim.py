...
#PSF1 /= PSF1.sum()
PSF1_std = pyfits.getdata('LID1538_PSF_std.fits')[30:-30,30:-30]
PSF1_std *= 10**5
fixcenter = False
#tag = 'test'
tag = 'PSF_std+Boost_center'
ID = 'Sim'
exp_time=2400.
background_rms = 0.0076
source_result, ps_result, image_ps, image_host, data_C_D=fit_qso(QSO_im=image_noisy, psf_ave=PSF1, psf_std=PSF1_std, source_params=source_params,pix_sz = 'drz06',
                                                                 background_rms=background_rms, image_plot = True, corner_plot=True,
                                                                 flux_ratio_plot=True, deep_seed = False, fixcenter= fixcenter,
