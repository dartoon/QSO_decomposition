...
fixed_source.append({})
kwargs_source_init.append({'R_sersic': .5, 'n_sersic': ini_n, 'e1': 0., 'e2': 0., 'center_x': 0., 'center_y': 0.})
...
source_result, ps_result, image_ps, image_host, data_C_D=fit_qso(QSO_im=image_noisy, psf_ave=PSF1, source_params=source_params,
                                                                 ...
                                                                 exp_time = 400.,tag=None, no_MCMC=True)
result = transfer_to_result(data=image,
