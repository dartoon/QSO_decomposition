...
high1, x1, _ =plt.hist(Candles_reff, normed=True, histtype=u'step',linestyle=('dashed'), label=('CANDELS sample'), linewidth = 2, color='green')
...
plt.text(np.median(QSO_reff)-0.3, high_m0*0.15, '{0}'.format(round(np.median(QSO_reff),3)), color='black',fontsize=25)
...
high1, x1, _ =plt.hist(Candles_n, normed=True, histtype=u'step', linestyle=('dashed'), label=('CANDELS sample'), linewidth = 2, color='green')
...
plt.text(np.median(QSO_n)+0.1, high_m0*0.13, '{0}'.format(round(np.median(QSO_n),3)), color='black',fontsize=25)
