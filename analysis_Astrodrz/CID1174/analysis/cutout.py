...
fitsFile = pyfits.open('../astrodrz_sub_bkg_before_coadd/final_drz_0642.fits')
...
QSO_outer, cut_center2 = cut_center_bright(image=img, center=center_QSO, radius=200, return_center=True, plot=False)
...
for i in range(len(psf_list)):
    print 'PSF',i
    PSF = cut_center_bright(image=img, center=psf_list[i], radius=60, plot=False)
