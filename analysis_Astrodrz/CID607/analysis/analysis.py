...
psf_name_list = glob.glob("PSF?.fits")+ glob.glob("PSF??.fits") + glob.glob('not_count_*fits')     # Read *.reg files in a list.
psf_list = []
...
##==============================================================================
PSF_mask_list = glob.glob("PSF*.reg") # Read *.reg files in a list.
psf_ave_pa, psf_std_pa=psf_ave(psf_list,mode = 'CI', not_count=(0,1,2,3,4),   #5678910
                  mask_list=PSF_mask_list)

psf_ave_pb, psf_std_pb=psf_ave(psf_list,mode = 'CI', not_count=(0,1,2,3,4,5),   #678910
                  mask_list=PSF_mask_list)

psf_ave_pc, psf_std_pc=psf_ave(psf_list,mode = 'CI', not_count=(0,1,2,3,4,5,6),   #78910
                  mask_list=PSF_mask_list)

psf_ave_pd, psf_std_pd=psf_ave(psf_list,mode = 'CI', not_count=(0,1,2,3,4,5,6,7),   #8910
                  mask_list=PSF_mask_list)
...
psf_ave_pd, psf_std_pd = psf_ave_pd[ct:-ct,ct:-ct], psf_std_pd[ct:-ct,ct:-ct]


psf_com = ['5678910', '678910','78910','8910']
PSF_aves = [psf_ave_pa, psf_ave_pb, psf_ave_pc, psf_ave_pd]
PSF_stds = [psf_std_pa, psf_std_pb, psf_std_pc, psf_std_pd]
