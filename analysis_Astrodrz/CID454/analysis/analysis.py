...
# =============================================================================
#QSO_bkg_value= 0.000709277409205
#PSF_bkg_values = np.array([ 0.00097316,  0.0011986 ,  0.00053116,  0.00110269,  0.00027605,
#        0.00026886,  0.00035097,  0.00097316,  0.0011986 ,  0.00053116])
QSO_bkg_value= 0. 
...
##==============================================================================
PSF_mask_list = glob.glob("PSF*.reg")   # Read *.reg files in a list.
psf_ave_pa, psf_std_pa=psf_ave(psf_list,mode = 'CI', not_count=(0,1,2,3,4,5,6),   #789
                  mask_list=PSF_mask_list)

psf_ave_pb, psf_std_pb=psf_ave(psf_list,mode = 'CI', not_count=(0,2,8,9),   #134567
                  mask_list=PSF_mask_list)
