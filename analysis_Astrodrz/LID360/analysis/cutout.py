...
QSO, cut_center = cut_center_bright(image=img, center=np.array([1866,1365]), radius=60, return_center=True, plot=True)
...
#extra_psfs=None
extra_psfs = np.array([[1836, 1256],[1784,1265],[1063,1377],[1478,2370],
                       [1292,2418],[1049,2238],[1849,2506],[1493,509]])
...
if extra_psfs is None:
    ...
    save_loc_png(img,[1866,1365],None,extra_psfs, ID=ID,reg_ty = 'astrodrz_06', label_shift_NO=(5,6), shift_where=(4,3))
