...
psf_ave_pa, psf_std_pa=psf_ave(psf_list_sub,mode = 'CI', not_count=(0,1,2,3,4),
                  mask_list=mask_list)
#
psf_ave_pb, psf_std_pb=psf_ave(psf_list_sub,mode = 'CI', not_count=(0,1,2,3,4,6,7),
                  mask_list=mask_list)
#
...
#    source_result, ps_result, image_ps, image_host, error_map=fit_ps(QSO_im-0.0014673, psf_ave=psf_i, psf_std = None,
...
#    psf_i, _=psf_ave([psf_list[i]-PSF_sub_list[i]],mode = 'CI', not_count=(), mask_list=mask_list)
#    psf_i = psf_i[ct:-ct,ct:-ct]
#    source_result, ps_result, image_ps, image_host, error_map=fit_qso(QSO_im-0.0014673, psf_ave=psf_i, psf_std = None,
#                                                                     background_rms=background_rms,
...
#fixcenter = False
#fit_result = open('fit_result/PSF_56789_subsky.txt'.format(i),'w')
#tag = 'fit_result/PSF_56789_frame{0}_subsky'.format(frame)
#source_result, ps_result, image_ps, image_host, error_map=fit_qso(QSO_im-0.0014673, psf_ave=psf_ave_pa, psf_std = psf_std_pa, background_rms=background_rms,
...
print "by selected PSF, relax center"
fixcenter = False
fit_result = open('fit_result/PSF_589_subsky.txt'.format(i),'w')
tag = 'fit_result/PSF_589_frame{0}_subsky'.format(frame)
