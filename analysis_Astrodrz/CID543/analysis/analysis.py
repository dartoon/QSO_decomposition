...
#            plt_QSO = False
##            if i+k+j == 0:
##                plt_which_PSF = (0,1,2,3,4,5,6,8,9,10)
#            if i==1 and j+k ==0:
#                plt_QSO = True
...
#                                               include_QSO=if_QSO_l[i], not_plt=(7,),
...
#psf_a, psf_a_std=psf_ave(psf_list,mode = 'CI', not_count=(0,1,5,7,8),
#                  mask_list=mask_list)

psf_b, psf_b_std=psf_ave(psf_list,mode = 'CI', not_count=(0,1,2,3,4,5,7,8),
                  mask_list=mask_list)
#
#psf_b_mid=psf_ave(psf_list,mode = 'mid', not_count=(0,1,2,3,4,5,7,8),
#                  mask_list=mask_list)
#
