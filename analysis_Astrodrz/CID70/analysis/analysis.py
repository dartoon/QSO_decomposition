...
# =============================================================================
#QSO_bkg_value= 0.0013345774575726638
#PSF_bkg_values = np.array([ 0.00057138,  0.00040571,  0.00057053,  0.00113608,  0.00072694])
QSO_bkg_value= 0. 
...
##==============================================================================
PSF_mask_list = glob.glob("PSF*.reg")   # Read *.reg files in a list.
psf_ave_pa, psf_std_pa=psf_ave(psf_list,mode = 'CI', not_count=(0,1),   #234
                  mask_list=PSF_mask_list)

psf_ave_pb, psf_std_pb=psf_ave(psf_list,mode = 'CI', not_count=(0,1,4),   #23
                  mask_list=PSF_mask_list)
