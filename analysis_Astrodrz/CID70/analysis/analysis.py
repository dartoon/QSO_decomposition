...
#psf_a, psf_a_std=psf_ave(psf_list,mode = 'CI', not_count=(3,4),
#                  mask_list=mask_list)

psf_b, psf_b_std=psf_ave(psf_list,mode = 'CI', not_count=(3,4,5),
                  mask_list=mask_list)
#
#psf_b_mid=psf_ave(psf_list,mode = 'mid', not_count=(3,4,5),
#                  mask_list=mask_list)
