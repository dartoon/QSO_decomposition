...
psf_list = []
#not count 6, thus psf_name_list need one more
...
psf_a, psf_a_std=psf_ave(psf_list,mode = 'CI', not_count=(0,1,2,6),
                  mask_list=mask_list)

psf_b, psf_b_std=psf_ave(psf_list,mode = 'CI', not_count=(0,1,3,5,6),
                  mask_list=mask_list)
