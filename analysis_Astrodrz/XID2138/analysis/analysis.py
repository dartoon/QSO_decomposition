...
psf_a, psf_a_std=psf_ave(psf_list,mode = 'CI', not_count=(0,2,3,4,7),
                  mask_list=mask_list)

psf_b, psf_b_std=psf_ave(psf_list,mode = 'CI', not_count=(0,1,2,4,6,7),
                  mask_list=mask_list)
#
