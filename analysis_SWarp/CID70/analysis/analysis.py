...
PSF_216= pyfits.getdata("../../PSF_legacy/CID216_PSF.fits")
PSF_216_std = pyfits.getdata("../../PSF_legacy/CID216_PSF_std.fits")


prf_list = [QSO_im,psf_70,PSF_1174, PSF_452,PSF_216]
scal_list = [1,1,1,1,1]
prf_name_list = ['QSO_CID70','PSF_70_field' , 'PSF_1174_field', 'PSF_452_field', 'PSF_216_field']
...
fixcenter = False
print "Plan a"
source_result, ps_result, image_ps, image_host,data_C_D=fit_qso(QSO_im[cut:-cut,cut:-cut], psf_ave=PSF_452, background_rms=0.041, #psf_std = PSF_452_std,
