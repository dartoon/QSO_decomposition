...
psf_ave_pa, psf_std_pa=psf_ave(psf_list,mode = 'CI', not_count=(4,3,7,1),
                  mask_list=mask_list)

psf_ave_pb, psf_std_pb=psf_ave(psf_list,mode = 'CI', not_count=(4,3,7,1,8,5),
                  mask_list=mask_list)
...
#psf_1174_std = pyfits.getdata('../../PSF_legacy/CID1174_PSF.fits')  # Try to use PSF from CID1174 field. But failed.
