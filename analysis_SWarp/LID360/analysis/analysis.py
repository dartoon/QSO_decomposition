...
#                plt.close()
#
#psf_ave_pa, psf_std_pa=psf_ave(psf_list,mode = 'CI', not_count=(4,5,7,2,1),
#                  mask_list=mask_list)
#
#psf_ave_pb, psf_std_pb=psf_ave(psf_list,mode = 'CI', not_count=(4,5,7,2,1,3),
#                  mask_list=mask_list)
#
