...
psf_a, psf_a_std=psf_ave(psf_list,mode = 'CI', not_count=(0,2,4),
                  mask_list=mask_list)

#psf_b, psf_b_std=psf_ave(psf_list,mode = 'CI', not_count=(0,1,2,4),
#                  mask_list=mask_list)
psf_b = pyfits.getdata('../PSF_legacy/CID452_PSF.fits')
psf_b_std = pyfits.getdata('../PSF_legacy/CID452_PSF_std.fits')
