...
#extra_psfs = None
extra_psfs = np.array([[623.8144,4083.9444], [369.6544,3999.9844], [3597.7415,4822.0024], [5076.0712,4431.3522], [5646.4784,2831.0148], [2623.9933,289.50382], [798.03548,1824.7103]])
...
for i in range(len(PSFs)):
    ...
    _, PSF_mask = mask_obj(img=PSFs[i][0], snr=3.5, exp_sz=2.4)
    if len(PSF_mask) > 1:
