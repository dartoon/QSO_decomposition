...
Column 2: Redshifts.
Column 3: HST filter by WFC3. Note that the samples from the COSMOS field also has the ACS/F814W image.
...
\tablecolumns{9}
\tablewidth{0pt}
\tablecaption{The inference of the host information by the AGN decomposition for the 32 systems.} 
\tablehead
{ 
\colhead{Target ID}&
