...
Having defined the recipes, we estimate \mbh\ by adopting the emission line properties measured by \citet{Schulze2018}. There are 3/32 systems (i.e. CDFS-1, CDFS-229 and CDFS-724) not included in \citet{Schulze2018}; their \halpha\ emission lines information is provided by \citet{Suh2015}.
...
It is worth noting that for the local comparison sample, the bulge mass is equivalent to the total stellar mass. In other words, our local comparison is the \mbh-\smass$_{\rm ,bulge}$ and not those involving total quantities.

We include in our analysis published samples at intermediate redshift range to understand the redshift evolution of these correlations. We select samples that were analyzed by members of our team, in order to ensure uniform measurements. The intermediate redshift AGNs that we consider include, for the \mbh-\lhost\ relation, 52 objects published by \citet{Park15} at $0.36<z<0.57$ and 27 objects published by \citet{Bennert11, SS13} at $0.5<z<1.9$. Moreover, \citet{Bennert11, SS13} also derive the \smass\ for the 27 objects which enable us to compare to the \mbh-\smass\ relation. In addition, we adopt a sample of 32 \mbh-\smass\ measurements at $0.3<z<0.9$ by \citet{Cisternas2011} to compare with our sample.

Across the intermediate redshift sample, we recalibrate the \mbh\ by \halpha/\hbeta\ emission line using the self-consistent recipes introduced in Section~\ref{mbh}. For \mbh\ estimated by \Mgii\, we adopt the recipe by \citet{Ding2017b} to recalibrate them.
