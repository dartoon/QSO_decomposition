...
\colhead{Target ID}&
  ...
  \cline{2-5}  \cline{6-9} \\
\colhead{}& 
\colhead{FWHM($H\alpha$)}& \colhead{$\log( \rm L _{H\alpha}$)}& \colhead{$\log$\mbh}& Eddington ratio &
\colhead{FWHM($H\beta$)}& \colhead{$\log( \rm L _{\lambda5100})$}& \colhead{$\log$\mbh}& Eddington ratio \\
\colhead{}& 
