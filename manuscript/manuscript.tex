...
\end{eqnarray} 
where $\Delta \log \mathcal M_{\rm BH} = \log \big( \frac{\mathcal M_{\rm  BH}}{10^{7}M_{\odot}}) -\alpha-\beta\log(\frac{L_{R,0}}{10^{10}L_{\odot}})$. The best-fit and  1-$\sigma$ inference are $\gamma = 0.70 \pm 0.15$, as shown in Figure~\ref{fig:ML-vz}.
...
\centering
    \caption{The summary for the different inference of $\gamma$.}\label{table:gamma_sf}
     ...
     &&&\\
     \hline\hline
Entire sample & No & 0.70$\pm$0.15 & 0.74$\pm$0.17 \\
Entire sample & Yes & 0.60 $\pm$ 0.30 & 0.80 $\pm$ 0.30 \\
Only 32 AGNs & No & 1.13$\pm$0.20 & 0.80$\pm$0.20\\
Only 32 AGNs& Yes & 1.70$\pm$0.40 & 1.30$\pm$0.50\\
     \hline
     \end{tabular}}
    \tablecomments{
    Entire sample includes the 32 AGNs and the intermediate redshift AGNs from the reference in Section~\ref{sec:compare_sample}.
