...
galfit_loc = np.loadtxt('../Comparsion/CANDELS_catalog/cos_2epoch_wfc3_f160w_060mas_v1.0_galfit.cat')[:,[1,2]]  #RA, DEC
galfit = np.loadtxt('../Comparsion/CANDELS_catalog/cos_2epoch_wfc3_f160w_060mas_v1.0_galfit.cat')[:,[4,6,8,3]] # mag, re, n, flag

##The data from 3D HST
stellar_loc = np.loadtxt('../Comparsion/CANDELS_catalog/cosmos_3dhst.v4.1.cat')[:,[3,4]]  # RA, DEC
stellar_flux_ap = np.loadtxt('../Comparsion/CANDELS_catalog/cosmos_3dhst.v4.1.cat')[:,[69,51,39]]  # flux, F140w, F125w, F814w.
stellar = np.loadtxt('../Comparsion/CANDELS_catalog/cosmos_3dhst.v4.1.fout')[:,[1,6,8]]  # redshift, stellar mass, star formation rate
